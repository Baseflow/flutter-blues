...
#pragma mark - ProtosBluesRoot

@implementation ProtosBluesRoot
...
#pragma mark - ProtosBluesRoot_FileDescriptor

static GPBFileDescriptor *ProtosBluesRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[ProtosInt32Value class]
                                     rootClass:[ProtosBluesRoot class]
                                          file:ProtosBluesRoot_FileDescriptor()
                                        fields:fields
