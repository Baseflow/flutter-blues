...
#import "BluesPlugin.h"
#import "Blues.pbobjc.h"
...
@interface BluesPlugin ()
@property(nonatomic, retain) NSObject<FlutterPluginRegistrar> *registrar;
@property(nonatomic, retain) FlutterMethodChannel *channel;
@property(nonatomic, retain) BluesStreamHandler *stateStreamHandler;
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  ...
  // STATE
  BluesStreamHandler* stateStreamHandler = [[BluesStreamHandler alloc] init];
...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
  if ([@"setLogLevel" isEqualToString:call.method]) {
    ...
    FlutterStandardTypedData *data = [self toFlutterData:[self toBluetoothStateProto:self->_centralManager]];
    result(data);
...
- (ProtosBluetoothState*)toBluetoothStateProto:(CBCentralManager*)centralManager {
...
@implementation BluesStreamHandler
