...
import 'package:blues_example/widgets.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            children: <Widget>[
              StreamBuilder<List<BluetoothDevice>>(
                stream: Stream.periodic(Duration(seconds: 2))
                    .asyncMap((_) => Blues.instance.connectedDevices),
                initialData: [],
              ...
              StreamBuilder<List<ScanResult>>(
                stream: Blues.instance.scanResults,
                initialData: [],
                builder: (c, snapshot) => Column(
                  children: snapshot.data
                      .map(
      ...
      floatingActionButton: StreamBuilder<bool>(
        stream: Blues.instance.isScanning,
        initialData: false,
        builder: (c, snapshot) {
          if (snapshot.data) {
            return FloatingActionButton(
              child: Icon(Icons.stop),
              onPressed: () => Blues.instance.stopScan(),
